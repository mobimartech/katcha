...
app_sub:"Katcha",
    ...
    getAdId: function(adType, platform) {
      const adIds = {
        banner: {
          android: this.USE_TEST_ADS ? "ca-app-pub-3940256099942544/6300978111" : this.admobBannerAndroid,
          ios: this.USE_TEST_ADS ? "ca-app-pub-3940256099942544/2934735716" : this.admobBannerIOS
        },
        interstitial: {
          android: this.USE_TEST_ADS ? "ca-app-pub-3940256099942544/1033173712" : this.admobInterstitialAndroid,
          ios: this.USE_TEST_ADS ? "ca-app-pub-3940256099942544/4411468910" : this.admobInterstitialIOS
        },
        reward: {
          android: this.USE_TEST_ADS ? "ca-app-pub-3940256099942544/5224354917" : this.admobRewardAndroid,
          ios: this.USE_TEST_ADS ? "ca-app-pub-3940256099942544/5224354917" : this.admobRewardIOS
        }
      };
      return adIds[adType] && adIds[adType][platform] ? adIds[adType][platform] : null;
    },
    ...
    // Legal Links
    TERMS_URL: "https://social-tracker.automasterpro.net/terms.html",
    PRIVACY_URL: "https://social-tracker.automasterpro.net/privacy.html",
